...
// checkpoint. "dinov3/vitt16-ltdetr-coco" uses LT-DETR's default
// mean=(0,0,0), std=(1,1,1), so only /255 scaling applies. Always cross-check
// against the printed value from your own export.
