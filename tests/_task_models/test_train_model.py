...
def test_dinov3_ltdetr_load_train_state_dict_uses_ema_keys_and_forwards_kwargs() -> None:

    model = object.__new__(DINOv3LTDETRObjectDetection)

    captured: dict[str, Any] = {}

    def fake_load_state_dict(state_dict: dict[str, Any], strict: bool = True, assign: bool = False) -> str:
