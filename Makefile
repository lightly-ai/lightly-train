...
EXTRAS_PY312 := [dev,mlflow,notebook,onnx,inference,tensorboard,timm,ultralytics,wandb]
...
EXTRAS_DEV := [dev,mlflow,notebook,onnx,inference,tensorboard,timm,ultralytics,wandb]
