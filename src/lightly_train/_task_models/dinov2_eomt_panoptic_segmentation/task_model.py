...
class DINOv2EoMTPanopticSegmentation(TaskModel):
    model_suffix = "eomt"
    ...
    # to DINOv2PanopticSegmentationTrain.
    ...
    def freeze_backbone(self) -> None:
        chunked_blocks = self.backbone.chunked_blocks
