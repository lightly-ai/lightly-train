...
from lightly_train._models.model_wrapper import MultiScaleFeatureViT
...
class ViTSTAsBackboneWrapper(Module):
    def __init__(
        self,
        model_wrapper: MultiScaleFeatureViT,
        ...
        self.patch_size = model_wrapper.patch_size()
        ...
        _torch_helpers.register_load_state_dict_pre_hook(
            self, ViTSTAsBackboneWrapper._remap_legacy_keys
        )
    ...
    def _remap_legacy_keys(
        ...
        **kwargs: Any,
        ...
        if any(k.startswith(old_subprefix) for k in state_dict):
            logger.info(
                "Detected old ViTSTAsBackboneWrapper checkpoint format "
