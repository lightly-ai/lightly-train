...
def log_step(
    ...
    if agg_metric_values is not None:
        ...
        if (
            agg_metric_values.watch_metric_value is not None
            and agg_metric_values.watch_metric != loss_name
        ):
            parts.append(
                f"{agg_metric_values.watch_metric}: {agg_metric_values.watch_metric_value:4.4f}"
            )
