...
class PanopticSegmentationTransform(TaskTransform):
    transform_args_cls: type[PanopticSegmentationTransformArgs] = (
        PanopticSegmentationTransformArgs
    )

    def __init__(
        self,
        transform_args: PanopticSegmentationTransformArgs,
    ) -> None:
...
class MaskPanopticSegmentationCollateFunction(TaskCollateFunction):
    def __call__(
