...
class EoMTPanopticSegmentationTransformInput(TaskTransformInput):
    image: NDArrayImage
    mask: NDArrayMask


class EoMTPanopticSegmentationTransformOutput(TaskTransformOutput):
    image: Tensor
    mask: Tensor


class EoMTPanopticSegmentationTransformArgs(TaskTransformArgs):
...
class EoMTPanopticSegmentationTransform(TaskTransform):
    transform_args_cls: type[EoMTPanopticSegmentationTransformArgs] = (
        EoMTPanopticSegmentationTransformArgs
    )

    def __init__(
        self,
        transform_args: EoMTPanopticSegmentationTransformArgs,
    ) -> None:
    ...
    def __call__(
        self, input: EoMTPanopticSegmentationTransformInput
...
class EoMTMaskPanopticSegmentationCollateFunction(TaskCollateFunction):
    def __call__(
