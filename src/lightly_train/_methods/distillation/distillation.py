...
def get_teacher(teacher_name: str, teacher_weights: str | Path | None = None,  method_args: DistillationArgs | None = None,) -> Module:
...
class Distillation(Method):
    def __init__(
        ...
        self.teacher_embedding_model = get_teacher(
            teacher_name=method_args.teacher, teacher_weights=method_args.teacher_weights, method_args=method_args,
        )
