...
class DistillationRandomResizedCropArgs(RandomResizedCropArgs):
...
class DistillationTransformArgs(MethodTransformArgs):
    ...
    random_resize: DistillationRandomResizedCropArgs | None = Field(
        default_factory=DistillationRandomResizedCropArgs
    )
