...
`vitt16plus` backbones, which are pretrained by Lightly. DINOv3 models are
under the
[DINOv3 license](https://github.com/facebookresearch/dinov3?tab=License-1-ov-file).
EUPE models use [EUPE weights](https://github.com/facebookresearch/EUPE) pretrained
by Meta and are under the
