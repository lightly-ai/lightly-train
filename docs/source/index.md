...
- \[[0.11.0](https://docs.lightly.ai/train/stable/changelog.html#changelog-0-10-0)\] - 2025-08-15:
  🚀 You can now [distill](https://docs.lightly.ai/train/stable/methods/distillation.html)
  from [DINOv3](https://ai.meta.com/dinov3/) (experimental 🔬) -->
  Try it out [HERE](https://docs.lightly.ai/train/stable/methods/distillation.html)! 🚀
  from [DINOv3](https://ai.meta.com/dinov3/) (experimental 🔬)! 🚀
