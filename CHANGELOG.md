...
- Add multi-channel image input support to the `edgecrafter` (ECViT) model package, like
  DINOv2, DINOv3, and TIMM. Pretrained RGB weights are adapted to the requested number
  of channels on load.
