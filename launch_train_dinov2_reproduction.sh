...
#SBATCH --output=/logs/thomas/dinov2/250604_dinov2_reproduction_fp16/dinov2_train_%j.out
#SBATCH --error=/logs/thomas/dinov2/250604_dinov2_reproduction_fp16/dinov2_train_%j.err
#SBATCH --nodes=1
...
srun python train_dinov2_reproduction.py \
    --out /logs/thomas/dinov2/250604_dinov2_reproduction_fp16 \
